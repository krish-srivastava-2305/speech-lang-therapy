...
const SessionCard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#2fa2d7] to-[#035790] py-12 px-4 sm:px-6 lg:px-8 rounded-3xl">
      <Toaster />
      <div className="max-w-7xl mx-auto">
        <h1 className="text-center text-4xl sm:text-5xl font-extrabold text-blue-900 mb-12 tracking-tight leading-tight">
